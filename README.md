...
It is designed to work with the built-in DDNS clients of network devices like routers and NAS. These clients usually offers very limited choices of DNS service provider so you may want to use your own. Luckily many big DNS service providers allow updating DNS records through API, and so here comes this tool!
